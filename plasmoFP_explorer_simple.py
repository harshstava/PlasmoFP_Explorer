...
def main():
    ...
    **PlasmoFP Explorer** is a Streamlit web application for exploring protein function prediction 
    for *Plasmodium* species. Predictions are generated by [PlasmoFP](https://github.com/harshstava/PlasmoFP_public), a structure-informed deep learning model developed specifically for *Plasmodium* species. For more infromation on PlasmoFP, please refer to the manuscript: PlasmoFP: leveraging deep learning to predict protein function of uncharacterized proteins across the malaria parasite genus 
